...
class FaceSimTest(object):
    ...
    def face_sim_test(self):
        ...
        with codecs.open("/home/praveen/Working_files/Age_Gender_Work/face_sim_pred.csv", "w", encoding="utf-8") as output_file:
            ...
            for image1 in image_list1:
                for image2 in image_list2:
                    ...
                    api_url = "http://180.151.75.164:8080/ml/result/face_comparison?img_url1={}&img_url2={}".format(image1_url, image2_url)

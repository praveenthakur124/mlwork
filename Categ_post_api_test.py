...
class TestPostApiCateg(object):
    ...
    def req_api_result(self):
        ...
        with codecs.open('/home/praveen/Working_files/Category_Work/post_cat_api_result.csv', 'w', encoding='utf-8') as ouput_file:
            ...
            for row in meta_file.values:
                ...
                try:
                    inp = requests.post(api_url, data=data, headers=header)

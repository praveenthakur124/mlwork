...
class TestPostApiSubCategory(object):
    def __init__(self, input_file):
        self.input_file = input_file

    def req_api_result(self):
        data_list = []
        ...
        with codecs.open('/home/praveen/Working_files/Category_Work/UK_post_subcateg_result.csv', 'w', encoding='utf-8') as ouput_file:
            ...
            for row in meta_file.values:
                ...
                data = {'description': description, 'method': 'subcateg'}
                print(json.dumps(data))
                try:
                    inp = requests.request('POST', api_url, data=data)
...
obj = TestPostApiSubCategory("/home/praveen/Working_files/Category_Work/shuffle_UK_channel_meta.csv")
obj.req_api_result()
